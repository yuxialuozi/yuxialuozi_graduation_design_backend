...
func InitializeApp() (*router.Router, func(), error) {
	...
	routerRouter := router.NewRouter(configConfig, authHandler, authService, tenantHandler, contractHandler, roomHandler, feeHandler, maintenanceHandler, reportHandler)
